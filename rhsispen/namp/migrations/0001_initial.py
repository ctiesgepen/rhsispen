# Generated by Django 3.2 on 2021-08-06 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.CharField(choices=[('GERAR ESCALAS', 'GERAR ESCALAS'), ('CONSOLIDAR FREQUENCIAS', 'CONSOLIDAR FREQUENCIAS')], max_length=25, verbose_name='Evento do Período')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_vinculo', models.CharField(choices=[('Concursado', 'Concursado'), ('Contrato', 'Contrato'), ('Estágio', 'Estágio'), ('Jovem Aprendiz', 'Jovem Aprendiz'), ('Terceirizado', 'Terceirizado')], max_length=25, verbose_name='Tipo de Vínculo')),
        ...
        migrations.AddField(
            model_name='equipe',
            name='fk_setor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='equipes', to='namp.setor', verbose_name='Setor'),
        ),
        migrations.AddField(
            model_name='equipe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_equipe', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='namp.equipe', verbose_name='Equipe')),
                ('fk_servidor', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='servidores', to='namp.servidor', verbose_name='Servidor')),
